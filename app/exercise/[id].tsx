...
// Exercise images mapping — cache-bust v3 Jun 9 2026
...
const DATA: Record<string, ExerciseData> = {
  ...
  'cat-cow': {
    ...
    instructions: [
      ...
      'Inhale and arch your spine while lifting your chest and head (Cow).',
      'Move slowly and deliberately between positions.',
    ],
    mistakes: [
      'Moving too fast',
      'Holding your breath',
